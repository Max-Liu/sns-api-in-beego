...
// oprations for Images
type ImagesController struct {
	beego.Controller
}

func (this *ImagesController) URLMapping() {
...
// @Success 200 {int} models.Images.Id
// @Failure 403 body is empty
// @router / [post]
func (this *ImagesController) Post() {
	var v models.Images
	json.Unmarshal(this.Ctx.Input.RequestBody, &v)
	if id, err := models.AddImages(&v); err == nil {
...
// @router /:id [get]
func (this *ImagesController) GetOne() {
...
// @router /:id [put]
func (this *ImagesController) Put() {
	idStr := this.Ctx.Input.Params[":id"]
	id, _ := strconv.Atoi(idStr)
